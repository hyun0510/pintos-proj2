...
size_t bitmap_scan_and_flip_next(struct bitmap *b, size_t start, size_t cnt, bool value, size_t *last_idx);
size_t bitmap_scan_and_flip_best(struct bitmap *b, size_t start, size_t cnt, bool value);
